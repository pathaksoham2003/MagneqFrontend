  ...
  const navigate = useNavigate();
    return(
      <div className="grid gap-4 md:gap-6 bg-background text-text ">
        ...
        <Button type="button" size="md" variant="primary" startIcon={<HiOutlineArchiveBox/>} onClick={()=>{navigate("/create_order")}}>
          Create Order
        </Button>
        <Button type="button" size="md" variant="primary" startIcon={<PiCubeDuotone/>} onClick={()=>{navigate("/track_order")}}>
          Track Orders
        </Button>
